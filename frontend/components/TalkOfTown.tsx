...
const TalkOfTown = ({ carddata }: TalkOfTownProps) => {
  return (
    <div className=" border-[#B81F2E] border rounded-3xl pb-4 bg-white shadow-xl w-[310px] max-h-[423px] flex justify-center">
      <div className="relative w-full ">
        ...
        <div className='absolute w-full flex justify-between items-center px-4 -top-1 right-0'>
          <div className="-top-1">
            ...
            <svg width="47" height="76" viewBox="0 0 47 76" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <filter id="filter0_dddd_17_189" x="0.446929" y="0.362069" width="45.7524" height="74.9854" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <div className="px-3 w-full">
          ...
          <div className="flex px-1 gap-3 justify-between items-center">
            ...
            <button className="bg-custom-red font-poppins text-lg ml-2 w-full text-white py-2 px-4 rounded-full ">
              Add to Cart
            </button>
          </div>
        </div>
