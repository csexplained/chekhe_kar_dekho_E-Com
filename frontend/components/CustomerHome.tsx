...
// Sample data for fans' reviews
const fansData: FansCardProps[] = [
  {
    src: "/profile1.png",
    customerName: "John Doe",
    text: "Absolutely loved the flavors! Can't wait to try more.",
    rating: 5,
  },
  {
    src: "/profile2.png",
    customerName: "Jane Smith",
    text: "The best pickle I've ever tasted. Highly recommended!",
    rating: 4,
  },
  {
    src: "/profile3.png",
    customerName: "David Johnson",
    text: "Amazing quality and taste. Will buy again!",
    rating: 5,
  },
  {
    src: "/profile4.png",
    customerName: "Emily Brown",
    text: "Unique flavors that remind me of home. Loved it!",
    rating: 4,
  },
];
...
const FansCard = ({ carddata }: { carddata: FansCardProps }) => {
  return (
    <div className="flex flex-col border border-gray-300 rounded-xl px-4 py-4 md:px-6 md:py-6 lg:px-8 lg:py-8 bg-white shadow-md w-64 md:w-72 lg:w-96">
      {/* Star Rating */}
      <div className="flex">
      ...
      <div className="flex items-center mt-4">
        <Image src={carddata.src} alt="profile" height={40} width={40} className="rounded-full" />
