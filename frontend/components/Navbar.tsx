      ...
      <div className="sticky top-0 w-full px-6 md:px-16 lg:px-16 h-[105px] flex justify-between items-center bg-white shadow-md z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden lg:flex gap-6 text-lg font-normal">
            <Link className={`${pathname === '/' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/">Home</Link>
            <Link className={`${pathname === '/shop' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/shop">Shop</Link>
            <Link className={`${pathname === '/sale' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/sale">Sale</Link>
            <Link className={`${pathname === '/launchingSoon' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/launchingSoon">Launching soon</Link>
            <Link className={`${pathname === '/ourStory' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/ourStory">Our Story</Link>
            <Link className={`${pathname === '/contactUs' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/contactUs">Contact Us</Link>
            <Link className={`${pathname === '/gifting' ? 'text-[#B81F2E]' : 'text-black'} hover:text-[#B81F2E] transition-colors duration-200`} href="/gifting">Gifting</Link>
          </nav>
        </div>
